...
class Bomber(object):
    ...
    def func0(self):
        ...
        browser.find_element_by_id('TANGRAM__PSP_10__smsPhone').send_keys(self.phone)
    ...
    def func1(self):
        ...
        browser.find_element_by_id('userName').send_keys('helloworld998')
        browser.find_element_by_id('phone').send_keys(self.phone)
        time.sleep(1)
    ...
    def func2(self):
        ...
        browser.find_element_by_id('sms_name').send_keys(self.phone)
    ...
    def func3(self):
        ...
        browser.find_element_by_id('cg_06').send_keys(self.phone)
